...
public class Boy {
	...
	private void loadInformations() {
		try {
			idle_R = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));
			idle_L = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));

			run_R[0] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));
			run_L[0] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));

			run_R[1] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));
			run_L[1] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));

			run_R[2] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));
			run_L[2] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));

			run_R[3] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));
			run_L[3] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));

			run_R[4] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));
			run_L[4] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));

			run_R[5] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));
			run_L[5] = ImageIO.read(getClass().getResource("/textures.sprites/PraiseStalin.png"));
	...
	public static final int BOY_START_X = 150;
	...
	// initially the character is placed at BOY_START_X
	private int currentY = GameFrame.HEIGHT - BOY_HEIGHT- 750;
